<section>
   <div class="banner-main">
      <img src="<?php echo base_url('images/header-bgsilk.jpg') ?>" alt="#" style="width: 100% ; height: 100%;" />
      <div class="text-bg">
         <div class="container">
            <form class="main-form">
               ...
               <div class="row">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                     <a href="pregled_ponuda.html" style="background-color: rgb(6, 47, 60);">Pretraži</a>
                  </div>
               </div>
            </form>
         </div>
