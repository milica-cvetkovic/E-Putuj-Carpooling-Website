    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12" align="center" style="margin-top: 20px;">
                <h1 style="font-size: 3em;">Beograd -> Budimpesta</h1>
            </div>
            ...
            <div class="col-sm-8" style="margin-top: 30px;">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>5
                            <span>
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Person_icon_BLACK-01.svg/1924px-Person_icon_BLACK-01.svg.png" height="25" width="25">
                            </span>
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="row">
            ...
            <div class="col-sm-1"><a href="azuriraj2.html"><button type="button" class="btn make-offer-btn" style="position: relative; left: 50%;">Ažuriraj ponudu</button></a></div>
